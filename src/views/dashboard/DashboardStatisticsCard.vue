...
export default {
  setup() {
    ...
    const resolveStatisticsIconVariation = data => {
      ...
      if (data === 'Ethereum') return { icon: mdiEthereum, color: 'success' }
      if (data === 'USDT') return { icon: mdiCurrencyUsd, color: 'warning' }
      if (data === 'Defix') return { icon: mdiCurrencyUsd, color: 'info' }
